...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center gap-8 px-4">
      ...
      <div className="flex flex-col items-center gap-2">
        <a
          href="https://github.com/KingDavidJnr/remota/releases/latest/download/remota-desktop.exe"
          className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-gray-200 text-sm font-medium px-6 py-2.5 rounded-xl transition-colors"
          download
        >
        ...
        <p className="text-gray-600 text-xs">Required to share your screen</p>
      </div>
    </div>
  );
}
